...
# ==============================================================================
# 2. BOOTSTRAP DATA & ADJACENCY ON MASTER
# ==============================================================================
...
T_train = 220
X_aligned_train = X_aligned[:, 1:T_train, :]

# Normalize and Spline
SHARED_DATA = log.(X_aligned_train .+ 1.0f0)
SHARED_TSTEPS = Float32.(collect(0:T_train-1))
...
# 3. EXECUTE RUN
# ==============================================================================
# BROADCAST VARIABLES (Master -> Workers)
...
@everywhere include("training_mlp.jl")
