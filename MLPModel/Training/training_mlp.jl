...
const CONFIG = (
    ...
    p5_epochs = 8000,   p5_lr = 5f-6,     p5_patience = 30
)
...
# ==============================================================================
function train_model(save_path::String, seed::Int, run_id::Int)
    strt_time = time()
    ...
    # Access Globally Broadcasted Variables (from passobj in master)
    ...
    tmp_gnn = ExplicitGNN(nin_tot, 128, 1, CONFIG.p_dropout_initial)
    ...
    # ==========================================================================
    println("\n--- PHASE 1: Temporal Chunking ---")
    gnn_p1 = ExplicitGNN(nin_tot, 128, 1, CONFIG.p_dropout_initial)
    ...
    gnn_p4 = ExplicitGNN(nin_tot, 128, 1, 0.0)
    ...
    # SAVE
    # ==========================================================================
    param_file = joinpath(save_path, "params_custom_run$(run_id)_seed$(seed).jld2")
    loss_file = joinpath(save_path, "lossHist_custom_run$(run_id)_seed$(seed).jld2")
