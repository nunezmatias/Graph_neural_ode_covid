...
* **`run_training_V2.jl`**: The main execution script for "training_custom_V2.jl". Adds a new normalization function for the adjacency matrix where you can choose the weights to assign to self-loops (0 to 1).
