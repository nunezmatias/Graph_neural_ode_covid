# Test 7: Train FULL GRAPH topology
...
TOPOLOGY = :full
println("=== Training: FULL GRAPH ===\n")

include("../../Train/preprocessing.jl")

# Model architecture (Test 2)
latent_dim = 3
...
# Use FULL graph (no modification)
g_train = g
...
@save "Resultados/test-7/checkpoints/params_full.jld2" ps_full
CSV.write("Resultados/test-7/checkpoints/loss_full.csv", DataFrame(epoch=1:length(loss_history), loss=loss_history))
println("\n✅ FULL GRAPH COMPLETE: Final Loss = $(round(loss_history[end], digits=6))")
