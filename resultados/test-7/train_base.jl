...
function plot_callback(state_data, pred_data, epoch, loss_history)
    ...
    savefig(plt_loss, "plots/training/epoch_$(epoch)_loss.png")
end
        ...
        for epoch in 1:nepochs
            ...
            if epoch % 25 == 0 || epoch < 5
                try
                    ...
                    println("Warning: Plotting failed at epoch $epoch: $e")
                end
            end
...
if abspath(PROGRAM_FILE) == @__FILE__
    ...
    # Save Params
    println("Saving parameters to Params/par_opt_test3.jld2")
    @save "Params/par_opt_test3.jld2" ps_trained

    # Plot
    mkpath("plots/training_test3")
    for node in 1:6
        ...
        savefig(plt, "plots/training_test3/final_state_$(states[node]).png")
    end
end
